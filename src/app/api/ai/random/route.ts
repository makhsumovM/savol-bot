...
VERY IMPORTANT RULES вЂ” FOLLOW EXACTLY:
- Output ONLY pure JSON, nothing else: no text, no explanations, no markdown
- Exactly 10 questions
- Each question must have:
  - "question" вЂ” question text
  - "answers" вЂ” exactly 4 answer options (strings)
  - "correctIndex" вЂ” number from 0 to 3, indicating the correct answer
${difficultyRule}
  - "code" вЂ” code or null
  - "codeLanguage" вЂ” code language or null
...
- Only 2 or 3 questions out of 10 should have code
  The remaining 7вЂ“8 questions вЂ” purely textual (code: null, codeLanguage: null)

- If there is code вЂ” the language must be correct:
  ${codeLanguages}
...
Make everything simple, clear and random вЂ” especially the position of the correct answer!
`
