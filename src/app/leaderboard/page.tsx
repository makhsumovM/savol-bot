...
import { Trophy, Calendar, Sparkles, BarChart3 } from 'lucide-react'
        ...
        {data && (
          <div className="space-y-6 sm:space-y-7">
            ...
            <motion.div
              ...
              className="relative rounded-3xl border border-border/60 bg-card/70 backdrop-blur-xl overflow-hidden"
              data-aos="fade-up"
            >
              ...
              <div className="hidden lg:block px-4 sm:px-6 py-4">
                <div className="grid grid-cols-[80px_1.4fr_1fr_1fr_1fr_1.1fr] items-center gap-3 text-[11px] font-bold uppercase tracking-wide text-muted-foreground">
                  <span className="text-center">#</span>
                  <span>{t('leaderboard.columns.name')}</span>
                  <span className="flex items-center gap-2 justify-center">
                    <Image src={reactIcon} alt="Frontend" width={20} height={20} className="w-5 h-5" />
                    Frontend
                  </span>
                  <span className="flex items-center gap-2 justify-center">
                    <Image src={charmIcon} alt="Backend" width={20} height={20} className="w-5 h-5" />
                    Backend
                  </span>
                  <span className="flex items-center gap-2 justify-center">
                    <Image src={mobileIcon} alt="Mobile" width={20} height={20} className="w-5 h-5" />
                    Mobile
                  </span>
              ...
              <div className="hidden md:grid lg:hidden px-4 sm:px-6 py-3 grid-cols-3 items-center gap-3 text-[11px] font-bold uppercase tracking-wide text-muted-foreground">
              ...
              <div className="relative space-y-3 sm:space-y-4 px-2 sm:px-3 pb-4">
                {data.map((player, idx) => (
