...
const modes = [
  {
    ...
    title: 'Marathon',
    badge: 'LIVE',
    desc: 'Бесконечный поток вопросов для прокачки концентрации.',
  },
  {
    id: 'classic',
    title: 'Classic',
    badge: 'SOON',
    desc: 'Спринт из 10–15 вопросов, чтобы быстро проверить себя.',
  },
  {
    id: 'coding',
    title: 'Coding',
    badge: 'SOON',
    desc: 'Задачи с код-блоками и подсказками, вдохновлено IDE.',
  },
]
          ...
          <div className="space-y-4">
            ...
            >
              <h1 className="text-5xl md:text-7xl font-bold tracking-tight bg-linear-to-br from-foreground via-foreground to-foreground/60 bg-clip-text text-transparent leading-[1.1]">
                <Typewriter text="Savol-bot" />
              </h1>
            </motion.div>
            <motion.p className="text-xl md:text-2xl font-medium text-foreground/80">
              <Typewriter text="AI тестировщик" delay={0.6} />
            </motion.p>
          </div>
          <motion.p className="max-w-xl text-muted-foreground text-lg leading-relaxed">
            <Typewriter
              text="Выбирай режим на первом экране, погружайся в вопросы без лишних кликов и держи фокус с лаконичными анимациями."
              delay={1.4}
              speed={0.02}
            />
          </motion.p>
        ...
        >
          ...
          <div className="relative rounded-3xl border border-border/50 bg-card/50 backdrop-blur-xl p-8 shadow-2xl hover:shadow-3xl transition-shadow duration-500">
            <div className="flex items-center justify-between mb-8">
              <span className="text-sm font-semibold text-primary tracking-wide">Pulse UI</span>
            ...
            <div className="space-y-6">
              {['Строка 1', 'Строка 2', 'Строка 3'].map((row, i) => (
