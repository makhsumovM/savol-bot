...
const GameOver = ({ currentScore, record, onRestart }: IGameOverProps) => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-destructive/5 via-transparent to-primary-2/5 pointer-events-none" />
      ...
      {isNewRecord && (
        <motion.div
          ...
          className="absolute top-1 right-1 flex items-center gap-1.5 px-3 py-1.5 bg-gradient-to-r from-yellow-500 to-amber-500 rounded-full text-white text-xs font-bold shadow-lg"
        >
      ...
      >
        ...
        <div className="relative flex items-center justify-center w-20 h-20 rounded-full bg-gradient-to-br from-destructive/20 to-destructive/5 border border-destructive/30">
      ...
      <motion.h1
        ...
        className="relative text-3xl md:text-4xl font-black tracking-tight bg-gradient-to-r from-destructive via-orange-500 to-destructive bg-clip-text text-transparent"
      >
        {t('gameOver.title')}
      </motion.h1>
      ...
      >
        <div className="relative overflow-hidden rounded-2xl border border-primary-2/30 bg-gradient-to-br from-primary-2/10 to-primary-2/5 p-4">
        ...
        <div className="relative overflow-hidden rounded-2xl border border-amber-500/30 bg-gradient-to-br from-amber-500/10 to-orange-500/5 p-4">
      ...
      <motion.button
        ...
        className="relative mt-4 group overflow-hidden px-8 py-3.5
          bg-gradient-to-r from-primary-2 to-primary-2/90 text-white rounded-2xl
