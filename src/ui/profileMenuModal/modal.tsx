    ...
    <AnimatePresence>
      {profileMenuModalOpen && (
        <motion.div
          ...
          className={
            'absolute mt-10 right-0  md:right-0 z-50 w-48 rounded-xl border border-border backdrop-blur-xl bg-card/90'
          }
        >
          <button
            onClick={() => {
            ...
            className="flex w-full items-center gap-2 px-4 py-2.5 text-sm text-foreground hover:bg-accent/40 transition-colors"
          >
            <User size={16} />
